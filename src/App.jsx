            ...
            <div className="hero-text-col">
              ...
              <div className="download-options">
                <div className="btn-wrapper">
                  <a href="https://github.com/AGhaith/GhaithTVWebsite/releases/download/GhaithTV-Android-V1.1.4/GhaithTV.apk" className="btn btn-primary glass">
                    <Download size={20} /> {t.btnAndroid}
                  </a>
                </div>
                <div className="btn-wrapper">
                  <a href="https://github.com/AGhaith/GhaithTVWebsite/releases/download/GhaithTV-Windows-V1.1.4/Ghaith.TV.Setup.1.1.4.exe" className="btn btn-secondary glass">
